<?php
session_start();
$conn = mysqli_connect("localhost","root","","bezzine");
...
{  
	...
	$sql1 = "INSERT INTO users_login(`email`, `password`) VALUES ('$email', '$pw');";
...
function validate()
{
	...
	if((mob.value.length!= 9))
	{
		alert("Enter the valid Mobile Number(Like : 123456789)");
		mob.focus();
		return false;
	}
...
<OPTION VALUE="Khezama" style="color:black;">Khezama</OPTION>
<OPTION VALUE="Sousse Jawhra" style="color:black;">Sousse Jawhra</OPTION>
<OPTION VALUE="Cite Riadth" style="color:black;">Cite Riadth</OPTION>
<OPTION VALUE="Kantaoui" style="color:black;">Kantaoui</OPTION>
</SELECT></TD>
</TR>
<TR class="left">
<TD><FONT size="5" color="WHITE">Mobile Number:</FONT></TD>
<TD><INPUT type="TEXT" name="mob" size="30" maxlength="9" placeholder="Enter your mobile number" id="mob"></TD>
</TR>
<TR class="left">
...
<INPUT TYPE="submit" value="login" name="gotologin" id="login" class="button">
</P>
</FORM>
